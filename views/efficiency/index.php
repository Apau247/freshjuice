...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="?route=efficiency/form" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Record Data</a>
    </div>
                    ...
                    <?php if (!empty($efficiencies)): ?>
                        <?php foreach ($efficiencies as $row): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="?route=efficiency/form&id=<?php echo sanitize($row['EfficiencyID']); ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
