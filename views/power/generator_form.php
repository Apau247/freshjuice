<?php $pageTitle = 'New Generator Log'; ?>
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form method="POST" action="?route=power/generator/create" class="row g-3">
            <?= csrfField() ?>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="number" step="0.1" name="runtime_hrs" class="form-control" value="0">
            </div>
            <div class="col-md-4">
                <label class="form-label fw-semibold">Fuel Used</label>
                <input type="number" step="0.01" name="fuel_used" class="form-control" value="0">
            </div>
            <div class="col-md-4">
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-success"><i class="bi bi-check-lg"></i> Save Log</button>
