...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="?route=training/form" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Add Training</a>
    </div>
                    ...
                    <?php if (!empty($trainings)): ?>
                        <?php foreach ($trainings as $row): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="?route=training/form&id=<?php echo sanitize($row['TrainingID']); ?>" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
