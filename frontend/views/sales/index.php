        ...
        <table id="dataTable" class="table table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="?route=sales/receipt&id=<?= urlencode($o['OrderID']) ?>" target="_blank" rel="noopener"
                           class="btn btn-sm btn-outline-success" title="Print receipt"><i class="bi bi-receipt"></i></a>
