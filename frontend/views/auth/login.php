    ...
    <div class="login-card">
        <div class="login-brand">
            <div class="login-brand-icon">
                <img src="<?= appBaseUrl() ?>/frontend/assets/img/pf-logo.jpg" alt="PF" style="width:64px;height:64px;object-fit:contain;border-radius:12px;background:#fff;">
            </div>
            <h3><?= APP_NAME ?></h3>
            <p>Propine Fruity &middot; <em><?= sanitize(APP_TAGLINE) ?></em></p>
        </div>
        ...
        <form method="POST" action="?route=auth/login">
            ...
            <div class="text-end mb-3">
                <a href="?route=auth/forgot" class="text-decoration-none" style="font-size:0.82rem;color:var(--brand, #16a34a);">Forgot Password?</a>
            </div>
